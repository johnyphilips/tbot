...
<?php if ($sum >= balance_service::MIN_WITHDRAW): ?>
👇 Please write below the number of coins that you are going to withdraw

❗️The minimum withdrawal amount is <code><?php echo balance_service::MIN_WITHDRAW; ?> coins</code>.
<?php else: ?>
...
🚫 Sorry, withdrawal is not possible because you do not have coins.
